...
def main():
    ...
    base_config = MultimodalModelConfig(
        ...
        checkpoint_path="data/output/checkpoints/0411_LGPA_3e4_256ft_b8_e80_heads_8-4-8-4-4-4_baseline_k15_f256_b8_e80.pth",
        layers_to_load=[
    ...
    try:
        run_ablation_studies(
            ...
            model_name="0412_ablation_35e-5_heads_8-4-8-4-4-4",
            batch_size=8,
