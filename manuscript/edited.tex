...
\acknowledgments{\hl{The} %MDPI: Please ensure that all individuals included in this section have consented to the acknowledgement.
 authors wish to express their sincere gratitude to Lloyd L. (``Pete'') Coulter (Center for Earth Systems Analysis Research, Department of Geography, SDSU) for his skillful piloting and management of all UAV LiDAR data acquisition campaigns; this data was foundational to the presented research. Separately, during the preparation of this manuscript, generative AI models (including Google's Gemini, Anthropic's Claude, and OpenAI's ChatGPT) were utilized to assist with language refinement, conceptual brainstorming, generation of preliminary code structures, and code debugging. The authors have reviewed and edited all AI-generated suggestions and take full responsibility for the content of this publication.}

\conflictsofinterest{The authors declare no conflicts of interest. The funders had no role in the design of the study; in the collection, analyses, or interpretation of data; in the writing of the manuscript; or in the decision to publish the \hl{results.} %MDPI: We found “Table A1” has been removed in this version, please check if it is correct. Please check if “Table A1” should be added back.
} 
...
\begin{adjustwidth}{-\extralength}{0cm}
 ...
 of vegetation growth reconstruction (using the experimental 8\hl{x} %MDPI: Please check if this should be a multiplication sign (“×” U+00D7).
...
\begin{adjustwidth}{-\extralength}{0cm}
    ...
    \end{adjustwidth}
    \caption{\hl{A second} %MDPI: 1. Commas are only used for numbers with five or more digits. We removed them in four-digit numbers in the figure. Please confirm. 2. Please confirm if explanation should be added for colors in the image.
 example of vegetation growth reconstruction with the 8\hl{x} %MDPI: Please check if this should be a multiplication sign (“×” U+00D7).
 model.}
...
\begin{adjustwidth}{-\extralength}{0cm}
    \centering
    \includegraphics[width=0.98\linewidth]{figures/veg_loss_2x-1.png}
    \end{adjustwidth}
    \caption{\textit{Cont}.}
...
\begin{adjustwidth}{-\extralength}{0cm}
    \centering
    \includegraphics[width=0.98\linewidth]{figures/veg_loss_2x-2.png}
    \end{adjustwidth}
    \caption{\hl{Example} %MDPI: 1. Commas are only used for numbers with five or more digits. We removed them in four-digit numbers in the figure. Please confirm. 2. Please confirm if explanation should be added for colors in the image. 3. To reduce the blank page, we made a sequel, please confirm.
 of the standard 2\hl{x} %MDPI: Please check if this should be a multiplication sign (“×” U+00D7).
