...
% Map Unicode minus (U+2212) to a regular ASCII minus to avoid compilation errors
\DeclareUnicodeCharacter{2212}{-}

% --- Disable editor highlighting boxes ---
% The MDPI editing markup uses \hl{...} (from soul), which is fragile in moving
% arguments (captions, headings) and breaks compilation. Neutralize it to a no-op.
\makeatletter
\renewcommand{\hl}[1]{#1}
\makeatother
...
\hl{Accurate} %MDPI: We found “Table A1” has been removed in this final version, please check if it should be added back. Please check all the Figures in this version and ensure that there are no duplicated Figures and there are no Figures missing (MM: see layer_specs table in appendix)
...
\begin{tabularx}{\textwidth}{lCC} %MM: Please do not make table textwidth. Adds too much whitespace and hinders readability.
\toprule
