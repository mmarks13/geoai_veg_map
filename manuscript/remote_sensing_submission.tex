...
\TitleCitation{Attention-Based Enhancement of Outdated Airborne LiDAR in Natural Landscapes using SAR and Optical Imagery Fusion}
...
\Author{Michael Marks $^{1,*}$, Daniel Sousa $^{1}$\orcidB{} and Janet Franklin $^{1,2}$\orcidC{}}
%\longauthorlist{yes}
